    ...
    def do_POST(self):
        ...
        try:
            ...
            if parsed.path == "/api/tts":
                ...
                log_event("tts_request", clientId=client_id, requestId=rid, session=session, voice=voice, mode=mode, textChars=len(text))
                if mode == "cosyvoice":
                ...
                log_event("tts_response", clientId=client_id, requestId=rid, session=session, voice=audio["voice"], mode=audio["mode"], filename=audio["filename"], bytes=audio["bytes"])
