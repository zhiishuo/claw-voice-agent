...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--vector-weight", type=float, default=0.7, help="Hybrid vector score weight.")
    parser.add_argument("--keyword-weight", type=float, default=0.3, help="Hybrid keyword score weight.")
